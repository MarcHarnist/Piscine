...
*	  FUNCTION INSIDE:
*/    class Panorama extends Database {
		...
		*/
			public function calcule(){
				...
				$this->solde_general = $this->credit + $this->solde;
				}
		...
		*/
			public function panorama_last_entry(){
				...
				$derniere_ligne = $budget_panorama->last_entry("budget_panorama");
				...
				*/
				...
				public function setCcp($value){
					$this->ccp = $value;
				}
				 

				public function setLivret($value){
					$this->livret = $value;
				}
