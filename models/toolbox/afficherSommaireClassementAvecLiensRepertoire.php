...
/  |________| -->
<section>
	<h2 class="text-info">Sommaire des travaux pratiques</h2>
	<ol>
		<?php 
		$index = "";
		$repertoires = "";
		...
		if ($index != "") $index = "<h3 class=\"text-info\">Index</h3><ol>$index</ol>";
		if ($repertoires != "")$repertoires = "<h3 class=\"text-info\">Repertoires</h3><ol>$repertoires</ol>";
		if ($fichiers != "") $fichiers = "<h3 class=\"text-info\">Fichiers</h3><ol>$fichiers</ol>";
		?>
